...
"""
    get_ϕVn(s::HSSRectSection, mat::Metal; axis=:strong, kv=5.0, rolled=false, ϕ=nothing) -> Force

Design shear strength ϕVn for rectangular HSS per AISC 360-16 Section G4 (LRFD).
