...
@testset "AISC Column Design" begin
    ...
    # For rolled W-shapes, Q ≈ 1.0 (no local buckling)
    # ==========================================================================
    @testset "Slenderness Factor Q" begin
        # Standard W-shapes should have Q = 1.0
        for name in ["W14X82", "W10X49", "W21X55"]
            section = W(name)
            q_factors = get_compression_factors(section, A992_Steel)
            
            # Rolled W-shapes are typically compact for compression
